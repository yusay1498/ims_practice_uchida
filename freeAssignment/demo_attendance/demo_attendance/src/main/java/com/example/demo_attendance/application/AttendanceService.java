...
public class AttendanceService {
    ...
    public AttendanceService(AttendanceRepository attendanceRepository, AttendanceSummaryRepository attendanceSummaryRepository, Clock clock) {
    ...
    public List<AttendanceSummary> viewAttendanceSummaryByEmployeeId(String employeeId) {
        return attendanceSummaryRepository.findMonthlyAttendanceSummaryByEmployeeId(employeeId);
    }
